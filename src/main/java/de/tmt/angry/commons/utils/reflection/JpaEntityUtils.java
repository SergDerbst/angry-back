package de.tmt.angry.commons.utils.reflection;

import static de.tmt.angry.commons.utils.reflection.ClassReflectionUtils.retrieveAnnotatedFields;
import static de.tmt.angry.commons.utils.reflection.ClassReflectionUtils.retrievePropertyFields;
import static de.tmt.angry.commons.utils.reflection.ClassReflectionUtils.retrieveTypeArgumentsOfField;
...
public class JpaEntityUtils {
	...
	public static <E> E updateEntity(final E entityToUpdate, final E entityToUpdateFrom) {
		try {
	...
	@SuppressWarnings("unchecked")
	public static <E, V> V retrieveFieldValue(final E entity, final Field field) throws Exception {
		field.setAccessible(true);
	...
	public static Field retrieveRelatingField(final Class<?> entityType, final Class<?> relatingEntityType) {
